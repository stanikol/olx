...
trait OLXScrapWS extends ScrapWS{

  protected def parseUserID(url:String): String = """http://.*ID(.*?)\.html.*""".r.findFirstMatchIn(url).get.group(1)
  ...
  protected def getPhones(id:String)(implicit wsClient: ahc.AhcWSClient, ec: ExecutionContext): Future[String] = {
  ...
  protected def getSkype(id:String)(implicit wsClient: ahc.AhcWSClient, ec: ExecutionContext): Future[String] = {
